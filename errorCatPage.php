      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="alert alert-danger" role="alert">
            <h4 class="alert-heading"><i class="fas fa-exclamation-triangle"></i></i>
              ¡Atención!
            </h4>
            <p>
              <?php
                 ...
                 //concatena variable para ver el evento
            ...
            <hr>
            <a href="FormCategoriasINS.php" class="btn btn-danger btn-sm mb-0">Volver</a>
          </div>
