...
<?php
    //crear sentencia sql
    $sql = "SELECT * FROM eventos WHERE bannerEVENT='destacado' LIMIT 5";
    //ejecutar sql
...
<div class="mensaje-error text-center">
    <p class="mensaje-error-titulo" >Error 404</p>
		<p class="mensaje-error-pie badge badge-primary">Página no encontrada</p>
</div>
